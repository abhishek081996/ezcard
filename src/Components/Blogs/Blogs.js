        ...
        <Row className="blogRow">
          <Col className="blogCard" sm={12} md={4}>
            <Link to="/blogcontent">
              ...
              <div className="tags">
                <p style={{ backgroundColor: `rgba( ${randomColor()},${randomColor()},${randomColor()},0.3)` }}>Leadership</p>
                <p style={{ backgroundColor: `rgba(${randomColor()} , ${randomColor()} , ${randomColor()},0.3)` }}>Management</p>
              </div>
            </Link>
          </Col>
          <Col className="blogCard" sm={12} md={4}>
            <Link to="/blogcontent">
              ...
              <p>
                The choice of Payment Gateway is a critical decision for any ecommerce business as per its growth perspective, and you as a business must
                consider{" "}
              </p>
              <div className="tags">
                <p style={{ backgroundColor: `rgba(${randomColor()},${randomColor()},${randomColor()},0.3)` }}>Leadership</p>
